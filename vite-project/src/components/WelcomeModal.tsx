...
export default function WelcomeModal({ isOpen, onClose, onCreateStore }: { isOpen: boolean; onClose: () => void; onCreateStore: () => void }): React.ReactNode {
  // Check if welcome modal has been shown before
  useEffect(() => {
    if (isOpen) {
      const hasSeenWelcomeModal: string | null = localStorage.getItem('hasSeenWelcomeModal');
      ...
      <div style={{
        ...
        <div style={{
          ...
          <button 
            ...
            onMouseOver={(e) => {
              (e.target as HTMLElement).style.backgroundColor = '#545b62';
            }}
            onMouseOut={(e) => {
