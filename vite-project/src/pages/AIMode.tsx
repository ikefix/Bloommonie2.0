...
const AIMode: React.FC = () => {
  ...
  const handleToggleAiMode = async (e?: React.MouseEvent) => {
  ...
  const handleAddExternalProduct = (product: any) => {
  ...
  const handleStoreProducts = async () => {
    ...
    try {
      ...
      const promises = productsToStore.map((product: any) =>
          ...
          <div className="command-history-card">
            ...
            <div className="history-list">
              {commandHistory.length === 0 ? (
                ...
                commandHistory.map((cmd: any, index: number) => (
        ...
        {showExternalProducts && (
          <div className="external-products-card">
            ...
            {isLoadingExternal ? (
              ...
              <div className="results-grid">
                {externalProducts.map((product: any, index: number) => (
          ...
          <div className="store-management-card">
            ...
            {productsToStore.length === 0 ? (
              ...
              <div className="store-list">
                {productsToStore.map((product: any, index: number) => (
